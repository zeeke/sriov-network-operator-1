...
var SRIOV_DEVICE_PLUGIN_POD corev1.Pod = corev1.Pod{
	ObjectMeta: metav1.ObjectMeta{
...
var _ = Describe("Config Daemon", func() {
	...
	BeforeEach(func() {
		...
		cleanFakeFs = fakeFs.Use()
		filesystemRoot = fakeFs.RootDir

		kubeClient := fakek8s.NewSimpleClientset(&FAKE_SUPPORTED_NIC_IDS_CM, &SRIOV_DEVICE_PLUGIN_POD)
