...
var VendorPluginMap = map[string]func(helpers plugin.HostHelpersInterface) (plugin.VendorPlugin, error){
...
func enablePlugins(ns *sriovnetworkv1.SriovNetworkNodeState, helpers plugin.HostHelpersInterface) (map[string]plugin.VendorPlugin, error) {
...
func registerVendorPlugins(ns *sriovnetworkv1.SriovNetworkNodeState, helpers plugin.HostHelpersInterface) (map[string]plugin.VendorPlugin, error) {
